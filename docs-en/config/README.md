...
- [Config File: config.yml](config.md): Main plugin configuration, language, database, and input cleanup.
- [Right-Click Item Bindings](item-bindings.md): Manage item menu entries and migrated TrMenu bindings in `item_bindings.yml`.
